...
CREATE UNIQUE INDEX XPKDEPARTMENT ON DEPARTMENT (Department_Name ASC,Company_Name ASC);
...
CONSTRAINT R_104 FOREIGN KEY (Department_Name, Company_Name) REFERENCES DEPARTMENT (Department_Name, Company_Name)
);
...
CONSTRAINT R_50 FOREIGN KEY (Department_Name, Company_Name) REFERENCES DEPARTMENT (Department_Name, Company_Name)
);
...
CREATE UNIQUE INDEX XPKNOK_14 ON NOK (Nok_Id ASC,Agreement_id ASC,Application_Id ASC,Cust_Id ASC);
...
CONSTRAINT R_83 FOREIGN KEY (Incident_Id) REFERENCES INCIDENT (Incident_Id),
CONSTRAINT R_86 FOREIGN KEY (Cust_Id) REFERENCES CUSTOMER (Cust_Id)
);
CREATE UNIQUE INDEX XPKINCIDENT_REPORT_18 ON INCIDENT_REPORT (Incident_Report_Id ASC,Incident_Id ASC,Cust_Id ASC);
...
(80101, 'Darshan', 'R.P', '1999-01-03' , 'M','Mysore',9546335667,'darshuputta@iiitdwd.ac.in', 4745255465, 'Single', 801),
(80102, 'Jagadeesh', 'C','2001-01-01' , 'M','Chitradurga',8540045339,'jagac553@iiitdwd.ac.in ', 1245512455, 'Single', 802),
(80103, 'Arun', 'kumar','1999-05-22' ,'M','Shivamogga',9855654754,'pindariarun@iiitdwd.ac.in ',5565842365,'Divorced', 803),
(80104, 'Gireesh', 'kumar','1998-12-12' ,'M','Andra pradesh',8875456264,'gireesh001@iiitdwd.ac.in ',4565855855,'Single', 804),
(80105, 'Bharath', 'chandra','1999-06-20' ,'M','Andra pradesh',9956854525,'bharaththuglife@iiitdwd.ac.in ', 7666658364,'Divorced', 805),
(80106, 'Kristene', 'stevert','1999-12-07 ','F','NewYork',6654565855,'kristen@iiitdwd.ac.in ', 7745858364,'Divorced', 806),
(80107, 'Peter', 'parker','1999-10-14' ,'M','NewYork',8875651200,'parker@iiitdwd.ac.in ', 7491111664,'Married', 807),
(80108, 'Harish', 'A','1999-04-25' ,'M','chitradurga',5574856300,'harish@iiitdwd.ac.in ', 7490000564,'Divorced', 808),
(80109, 'Nayana', 'R','1999-05-29 ','F','Banglore ',9985100345,'nayananayana@iiitdwd.ac.in ', 7787878664,'Married', 809),
(80110, 'Narayana', 'M','1998-09-16' ,'M','Banglore ',9857565810,'narayana@gmail.com ', 4548200364,'Divorced', 810),
...
INSERT INTO  APPLICATION VALUES 
	('80201', '80601', 'PENDING', 'Uninsured And Underinsured Motorist Coverage', '80101'),
...
/*    Inserting Values into  Insurance policy   */

INSERT INTO INSURANCE_POLICY VALUES 
	  ('80401' ,'20001','2020-02-08', '2022-02-08','Coverage And Protection against loss of or damage to your vehicle caused by theft','80201' ,'80101'),
...
/*    Inserting Values into  premium_payment     */

INSERT INTO PREMIUM_PAYMENT VALUES
(80501 , '20001' , 50000 ,'2018-12-23' , 82101, 80101 ),
...
/*    Inserting Values into  claim_setelement     */

INSERT INTO CLAIM_SETTLEMENT VALUES
...
/*    Inserting Values into  insurance_company     */    
...
INSERT INTO STAFF VALUES 
 ('80901','Raamu','K','Bidar',6795980389,'M','Married','Indian','MTech',100000, 80632451,'Bajaj Allianz Vehicle Insurance Company Limited'),
 ('80902','Vinayak','Kumar','Rayachuru',8600052431,'M','Divorced','Indian','MTech',70000, 80063252,'HDFC Vehicle Insurance Company Limited'),
 ('80903','Ramesh','H','Haasan',6705789530,'M','Unmarried','Indian','BA',20000, 56323453, 'Bajaj Allianz Vehicle Insurance Company Limited'),
 ('80904','Hitesh','H','Chitradurga',6763699981,'M','Married','Indian','BTech',10000, 805633454, 'Aegon Vehicle Insurance Company Limited'),
 ('80905','Manoj','M','Bagalkote',6752442045,'M','Married','Indian','MTech',50000, 56313480, 'HDFC Vehicle Insurance Company Limited'),
 ('80906','Chandan','shetty','Bangalore',6785240946,'M','Unmarried','Indian','MBA',37000, 96213456, 'Max Vehicle Insurance Company Limited'),
 ('80907','Nikhil','H.S','Mangalore',8848721479,'M','Married','Indian','MTech',18000, 80013457, 'Max Vehicle Insurance Company Limited'),
 ('80908','Manjunath','M','Chitradurga',9425797603,'M','Married','Indian','MTech',11000, 80013458, 'Bajaj Allianz Vehicle Insurance Company Limited'),
 ('80909','Fatima','Khanum','Chitradurga',9589892847,'M','Married','Indian','MTech',12500, 80013459, 'Max Vehicle Insurance Company Limited'),
 ('80910','Radha','k','Mangalore',7972990901,'M','Married','Indian','Matric',7000, 80013460,'Reliance Vehicle Insurance Company Limited'),
...
('Accounting Department', '81001', 'rajesh khanna', 'Shriram Vehicle Insurance Company Limited'),
('Agency Department', '81002', 'aniruddha', 'Future Generali India Vehicle Insurance Company Limited'),
('Actuarial and Statistical Department', '81003', 'pranav', 'Shriram Vehicle Insurance Company Limited'),
('Audit Department', '81004', 'mahesh bhatt', 'Aegon Vehicle Insurance Company Limited'),
('Audit Department', '81005', 'bharghava h.s', 'SBI Vehicle Insurance Company Limited'),
('Investment Department', '81006', 'mahesh kumar', 'IDBI Federal Vehicle Insurance Company Limited'),
('Claims Department', '81007', 'akash kumar', 'Birla Sun Vehicle Insurance Company Limited'),
('Claims and audit Department', '81008', 'rashmi', 'Birla Sun Vehicle Insurance Company Limited'),
('Claims and audit loss Department', '81009', 'sultan', 'Birla Sun Vehicle Insurance Company Limited'),
('Claims Department', '81010', 'priya sharma', 'IDBI Federal Vehicle Insurance Company Limited'),
('Legal Department', '81011', 'mithil anchani', 'Exide Vehicle Insurance Company Limited'),
('Legal Department', '81012', 'jagrut nemade', 'HDFC Vehicle Insurance Company Limited'),
('Legal Department', '81013', 'kshitz micheal ', 'ICICI Prudential Vehicle Insurance Company Limited'),
('Legal Department', '81014', 'sachin', 'IDBI Federal Vehicle Insurance Company Limited'),
('Legal Department', '81015', 'akarsh maurya', 'Kotak Vehicle Insurance Company Limited'),
('Marketing Department', '81016', 'udit pal', 'IDBI Federal Vehicle Insurance Company Limited'),
('Reinsurance Department', '81017', 'kapil sharma', 'Canara HSBC Oriental Bank of Commerce LIC Limited'),
('Underwriting Department', '81018', 'advay aggarwall', 'Bajaj Allianz Vehicle Insurance Company Limited'),
...
('CABD', 'Darhshan', '7654568943', 'Lucknow','170000','80916','Legal Department','ICICI Prudential Vehicle Insurance Company Limited'),
('DCEA', 'Jagadeesh', '6545675423', 'Bangalore', '130000','80901','Underwriting Department', 'Bajaj Allianz Vehicle Insurance Company Limited'),
('EFGW', 'Hanumanth', '7543445543', 'Bangalore', '140000','80903', 'Underwriting Department', 'Bajaj Allianz Vehicle Insurance Company Limited'), 
('GHIE', 'Kanaka', '2356765435', 'Jabalpur', '150000','80904','Reinsurance Department','Canara HSBC Oriental Bank of Commerce LIC Limited'),
('AJKT', 'Peter','9589026779', 'Mumbai', '220000','80913', 'Underwriting Department', 'Bajaj Allianz Vehicle Insurance Company Limited'), 
('KLMH', 'Akash',  '9875678763', 'Mumbai', '140000','80906', 'Reinsurance Department', 'Canara HSBC Oriental Bank of Commerce LIC Limited'),
('MNON', 'Umesh',   '9879543211', 'Pune', '150000','80907', 'Claims Department', 'Birla Sun Vehicle Insurance Company Limited'), 
('OPQZ', 'Bhargav','764166535', 'Mumbai', '160000','80908', 'Actuarial and Statistical Department', 'Shriram Vehicle Insurance Company Limited'),
('QRSF', 'Archana', '9876987652', 'Mumbai', '160000','80909', 'Reinsurance Department', 'Canara HSBC Oriental Bank of Commerce LIC Limited'), 
('STUN', 'Archana', '6756273891', 'Delhi', '140000','80910', 'Underwriting Department', 'Canara HSBC Oriental Bank of Commerce LIC Limited'), 
('AVWQ', 'Manoj', '770781155', 'Pune', '166000','80911', 'Legal Department','Kotak Vehicle Insurance Company Limited'),
...
INSERT INTO MEMBERSHIP VALUES('81201', '812IGT677643', '9422630900', '80101'),
...
/*    Inserting Values into  vehicle_services     */

INSERT INTO VEHICLE_SERVICE VALUES
...
INSERT INTO NOK VALUES 
('81401','Akhil','Hyderabad','9425284125','Male', 'Single','80401' ,'80201' ,'80101'),
 ('81402','Manjunath M','Bangalore','9425284354','Male', 'Married', '80402', '80202','80102'),
('81403','Anuradha','Pune','9425141254','Female', 'Married', '80403', '80203','80103'),
('81404','Ravi N','Mumbai','9425652322','Male', 'Single', '80404', '80204','80104'),
('81405','Yatish','Kolkatta','9425265455','Male', 'Divorced','80405' ,'80205' ,'80105'),
('81406','Meena','Pune','9425236525','Female', 'Divorced','80406' , '80206','80106'),
('81407','Lata','Vadodara','9425321466','Female', 'Single','80407' ,'80207' ,'80107'),
...
/*    Inserting Values into  policy_renewable     */

INSERT INTO POLICY_RENEWABLE VALUES
...
/*    Inserting Values into  incident_report     */
...
/*    Inserting Values into  coverage     */

INSERT INTO COVERAGE VALUES ('81901', '510000', 'Liability', 'HIGH', '82001', 'When accident takes place before your fault', '1 Year', 'Birla Sun Vehicle Insurance Company Limited'),
...
INSERT INTO INSURANCE_POLICY_COVERAGE VALUES
...
/* 		Query 1		 */
select * from  VEHICLE v inner join CUSTOMER c on v.Cust_id=c.Cust_id 
where c.Cust_id in ( select x.Cust_id from CLAIM x where x.Claim_Status = 'pending');

/* 		Query 2		 */
select * from CUSTOMER c1 where c1.Cust_id in
 (select p.Cust_id from PREMIUM_PAYMENT p 
 where (p.Premium_Payment_Amount > (select sum(CAST(Cust_Id as unsigned)) from CUSTOMER)));

/* 		Query 3		 */

select * from INSURANCE_COMPANY where Company_Name in 
(select OFFICE.Company_Name from OFFICE group by Company_Name
 having count(distinct (Address))>1 and Company_Name in 
(select DEPARTMENT.Company_Name from PRODUCT , DEPARTMENT
 where DEPARTMENT.Company_Name = PRODUCT.Company_Name group by DEPARTMENT.Company_Name 
 having count(distinct (Product_Number)) > count(distinct (Department_Name))));

/* 		Query 4		 */

select * from CUSTOMER where Cust_id in 
(select Cust_id from INCIDENT_REPORT where Cust_id in(select Cust_id from VEHICLE group by Cust_id
 having count(Cust_id) > 1) and Cust_id not in (select Cust_id from PREMIUM_PAYMENT));

/* 		Query 5		 */

select * from VEHICLE as v, PREMIUM_PAYMENT as p 
where v.Cust_id = p.Cust_id and p.Premium_Payment_Amount > v.Vehicle_Number;
...
select *
    ...
    where Cust_id in (
	   ...
	   where cl.Claim_Amount > cs.Claim_Settlement_id + cs.Vehicle_id + cl.Claim_id + cl.Cust_id and 
       cl.Claim_Amount < Coverage_Amount );
